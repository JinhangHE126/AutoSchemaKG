...
## Next mini-experiment (proposed)

**Context-aware entity resolution on Dulce:** cluster name variants for the 4 main characters, merge aliases, re-export a cleaned graph, and compare node count + duplicate rate + a few manual QA probes before vs after.
